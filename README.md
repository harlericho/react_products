...
Clone laravel api products project to your local machine:

> [https://github.com/harlericho/laravel_apiproducts.git](https://github.com/harlericho/laravel_apiproducts.git)
